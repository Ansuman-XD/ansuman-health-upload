    ...
    <section className="section-padding bg-secondary" ref={ref}>
      <div className="container-narrow mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <span className="inline-block px-4 py-2 rounded-full bg-accent/15 text-accent text-sm font-medium mb-4">
              Online Rehab Program
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-secondary-foreground leading-tight mb-6">
              Recovery, <span className="text-gradient-green">Reimagined.</span>
            </h2>
            <p className="text-white/60 leading-relaxed mb-8 max-w-md">
              Our digital rehabilitation platform brings world-class physiotherapy to your
              screen. Guided by certified therapists, track your progress, and recover on your
              schedule.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="hero-outline" size="xl" asChild>
                <a
                  href="https://wa.me/91XXXXXXXXXX?text=Hello,%20I%20am%20interested%20in%20the%20Online%20Rehab%20Program."
                  target="_blank"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {features.map((feature, i) => (
              <motion.div
                ...
                className={`glass-card-dark p-5 group hover:bg-white/10 transition-all duration-300 ${
