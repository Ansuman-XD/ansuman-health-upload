    ...
    <footer className="gradient-dark text-white/80">
      <div className="container-narrow mx-auto section-padding">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-white/60">
              Premium physiotherapy & personalized rehabilitation designed for long-term recovery. Evidence-based therapy with modern technology.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-white/60">
              <span>Sports Injury Rehab</span>
              <span>Post-Surgery Rehab</span>
              <span>Stroke Rehabilitation</span>
              <span>Back & Neck Pain</span>
              <span>Home Visit Therapy</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-white/60">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>info@physioelite.com</span>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center text-sm text-white/40">
          <p>© {new Date().getFullYear()} PhysioElite. All rights reserved. Built on Modern Digital Healthcare System.</p>
        </div>
      </div>
    </footer>
  );
