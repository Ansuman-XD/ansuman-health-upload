      ...
      <div className="container-narrow mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-foreground leading-tight">
            Comprehensive <span className="text-gradient-green">Rehabilitation</span>
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => (
            <motion.div
              ...
              className="glass-card p-6 sm:p-8 group hover:shadow-elevated transition-all duration-500 perspective-1000"
            >
              <div className="preserve-3d group-hover:[transform:rotateY(2deg)_rotateX(2deg)] transition-transform duration-500">
                ...
                <Button variant="whatsapp" size="sm" asChild>
                  <a
                    href={`https://wa.me/91XXXXXXXXXX?text=Hello,%20I%20am%20interested%20in%20${encodeURIComponent(service.title)}`}
                    target="_blank"
